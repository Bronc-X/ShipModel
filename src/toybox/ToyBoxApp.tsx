...
function getHistoryStlHref(entry: LocalHistoryEntry) {
  ...
  if (entry.status === "ready" && entry.runId) {
    return withStlSource(`/api/runs/${encodeURIComponent(entry.runId)}/download/stl`, entry.files.stlSourceUrl);
  }
  return "";
}
